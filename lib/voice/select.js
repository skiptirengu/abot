...
module.exports = {
  ...
  usage: function () {
    return {
      title: '<number>',
      description: 'Play the "**number**-th" video from the list returned from **!search**. This means, of course, that you should use **!search** before using this command. For a ***technical*** reason (that you probably don\'t care about) the results returned from your last **!search** are deleted 1 minute after you **!select** them. You can **!select** a music as many times as you want.',
      fields: [
